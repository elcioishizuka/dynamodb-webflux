package com.github.elcioishizuka.PoC.repository;
...
public class CustomerRepository {
    ...
    public CustomerRepository(DynamoDbEnhancedAsyncClient asyncClient) {
        ...
        this.customerDynamoDbAsyncTable = enhancedAsyncClient.table("customer_table", TableSchema.fromBean(Customer.class));
    }
